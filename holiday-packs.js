...
const HOLIDAY_PACKS = {
  ...
  wheel: {
    ...
    entries: [
      ...
      { name: 'Mabon',       month: 9,  day: 22, url: 'https://en.wikipedia.org/wiki/Wheel_of_the_Year',
  ...
  iroquois: {
    ...
    entries: [
      { name: 'Midwinter Ceremony',         month: 1,  day: 28, url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
      ...
      { name: 'Maple Thanksgiving',          month: 3,  day: 1,  url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Ahorn-Danksagung', fr:'Action de grâce de l\'érable', it:'Ringraziamento dell\'acero', es:'Acción de gracias del arce', la:'Gratiarum Actio Aceris' } },
      { name: 'Thunder Dance',               month: 4,  day: 15, url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Donnertanz', fr:'Danse du tonnerre', it:'Danza del tuono', es:'Danza del trueno', la:'Saltatio Tonitruum' } },
      { name: 'Sun Dance Thanksgiving',      month: 5,  day: 1,  url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Sonnentanz-Danksagung', fr:'Action de grâce de la danse du soleil', it:'Ringraziamento della danza del sole', es:'Acción de gracias de la danza del sol' } },
      { name: 'Seed Dance',                  month: 5,  day: 20, url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Saattanz', fr:'Danse des semences', it:'Danza dei semi', es:'Danza de las semillas', la:'Saltatio Seminum' } },
      { name: 'Strawberry Thanksgiving',     month: 6,  day: 15, url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Erdbeer-Danksagung', fr:'Action de grâce des fraises', it:'Ringraziamento delle fragole', es:'Acción de gracias de la fresa', la:'Gratiarum Actio Fragorum' } },
      { name: 'Green Bean Ceremony',         month: 8,  day: 1,  url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Grüne-Bohnen-Zeremonie', fr:'Cérémonie des haricots verts', it:'Cerimonia dei fagiolini', es:'Ceremonia del frijol verde' } },
      { name: 'Green Corn Ceremony',         month: 8,  day: 25, url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Grüne-Mais-Zeremonie', fr:'Cérémonie du maïs vert', it:'Cerimonia del granturco verde', es:'Ceremonia del maíz verde' } },
      { name: 'Harvest Thanksgiving',        month: 10, day: 5,  url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Ernte-Danksagung', fr:'Action de grâce de la récolte', it:'Ringraziamento del raccolto', es:'Acción de gracias de la cosecha', la:'Gratiarum Actio Messis' } },
      { name: 'Moon Dance',                  month: 5,  day: 10, url: 'https://oneida-nsn.gov/wp-content/uploads/2016/04/IROQUOIS-TRADITIONAL-CEREMONIES-8.17.pdf',
        i18n: { de:'Mondtanz', fr:'Danse de la lune', it:'Danza della luna', es:'Danza de la luna', la:'Saltatio Lunae' } },
    ],
  },
...
const HOLIDAY_PACK_LIST = [
  'us', 'wheel', 'hebrew', 'hindu', 'liturgical', 'cherokee', 'iroquois',
];
