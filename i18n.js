...
const I18N = {
  en: {
    ...
    view_sky: 'Sky', sky_short: 'Sky', view_hebrew: 'Hebrew',
    ...
    mode_calendar: 'Calendar', mode_calendar_short: 'Cal', label_view: 'View', span_month: 'Month',
    btn_prev_year: 'Previous year', btn_next_year: 'Next year', btn_pick_date: 'Pick a date',
  ...
  de: {
    ...
    view_sky: 'Himmel', sky_short: 'Hm', view_hebrew: 'Hebräisch',
    ...
    mode_calendar: 'Kalender', mode_calendar_short: 'Kal', label_view: 'Ansicht', span_month: 'Monat',
    btn_prev_year: 'Voriges Jahr', btn_next_year: 'Nächstes Jahr', btn_pick_date: 'Datum wählen',
    btn_options: 'Optionen', btn_about: 'Info', btn_print: 'Drucken',
    sky_labels: 'Beschriftungen', moon_label: 'Mond',
  ...
  fr: {
    ...
    view_sky: 'Ciel', sky_short: 'Ci', view_hebrew: 'Hébreu',
    ...
    mode_calendar: 'Calendrier', mode_calendar_short: 'Cal', label_view: 'Vue', span_month: 'Mois',
    btn_prev_year: 'Année précédente', btn_next_year: 'Année suivante', btn_pick_date: 'Choisir une date',
    btn_options: 'Options', btn_about: 'À propos', btn_print: 'Imprimer',
    sky_labels: 'Étiquettes', moon_label: 'Lune',
  ...
  it: {
    ...
    view_sky: 'Cielo', sky_short: 'Ci', view_hebrew: 'Ebraico',
    ...
    mode_calendar: 'Calendario', mode_calendar_short: 'Cal', label_view: 'Vista', span_month: 'Mese',
    btn_prev_year: 'Anno precedente', btn_next_year: 'Anno successivo', btn_pick_date: 'Scegli una data',
    btn_options: 'Opzioni', btn_about: 'Informazioni', btn_print: 'Stampa',
    sky_labels: 'Etichette', moon_label: 'Luna',
  ...
  es: {
    ...
    view_sky: 'Cielo', sky_short: 'Ci', view_hebrew: 'Hebreo',
    darkmoon_tooltip: 'Luna Oscura \u00b7 {0}',
    ...
    mode_calendar: 'Calendario', mode_calendar_short: 'Cal', label_view: 'Vista', span_month: 'Mes',
    btn_prev_year: 'Año anterior', btn_next_year: 'Año siguiente', btn_pick_date: 'Elegir fecha',
    btn_options: 'Opciones', btn_about: 'Acerca de', btn_print: 'Imprimir',
    sky_labels: 'Etiquetas', moon_label: 'Luna',
  ...
  sw: {
    ...
    view_sky: 'Anga', sky_short: 'An', view_hebrew: 'Kiebrania',
    ...
    mode_calendar: 'Kalenda', mode_calendar_short: 'Kal', label_view: 'Mtazamo', span_month: 'Mwezi',
    btn_prev_year: 'Mwaka uliopita', btn_next_year: 'Mwaka ujao', btn_pick_date: 'Chagua tarehe',
    btn_options: 'Chaguzi', btn_about: 'Kuhusu', btn_print: 'Chapisha',
    sky_labels: 'Maandishi', moon_label: 'Mwezi',
  ...
  la: {
    ...
    view_sky: 'Caelum', sky_short: 'Ca', view_hebrew: 'Hebraicus',
    ...
    mode_calendar: 'Calendarium', mode_calendar_short: 'Cal', label_view: 'Visus', span_month: 'Mensis',
    btn_prev_year: 'Annus Prior', btn_next_year: 'Annus Sequens', btn_pick_date: 'Diem Elige',
    btn_options: 'Optiones', btn_about: 'De Hoc', btn_print: 'Imprime',
    sky_labels: 'Inscriptiones', moon_label: 'Luna',
  ...
  sa: {
    moons: ['हिमचन्द्रः','जागरचन्द्रः','बीजचन्द्रः','विकासचन्द्रः','पुष्पचन्द्रः',
            'फलचन्द्रः','ग्रीष्मचन्द्रः','शस्यचन्द्रः','संग्रहचन्द्रः','पर्णचन्द्रः',
            'तुषारचन्द्रः','तमश्चन्द्रः','नीलचन्द्रः'],
    animals: ['रक्तकण्ठः','शशः','शकुनः','ऋक्षः','लोमशः'],
    weekdays_myth: ['विश्वदिनम्','कुजदिनम्','बुधदिनम्','गुरुदिनम्','शुक्रदिनम्','सोमदिनम्','रविदिनम्'],
    weekdays_std:  ['सोमवारः','मङ्गलवारः','बुधवारः','गुरुवारः','शुक्रवारः','शनिवारः','रविवारः'],
    greg_months: null, // falls back to English
    phases: { new:'अमावास्या', first:'शुक्लपक्षः', full:'पूर्णिमा', last:'कृष्णपक्षः' },
    solar:  { springEquinox:'वसन्तसाम्यम्', summerSolstice:'ग्रीष्मायनम्',
              autumnEquinox:'शरत्साम्यम्', winterSolstice:'शीतायनम्' },
    today: 'अद्य',
    save: 'संरक्ष', cancel: 'त्यज', add: 'योज',
    language: 'भाषा',
    settings_title: 'व्यवस्था',
    location: 'स्थानम्',
    lat: 'अ.', lon: 'दे.',
    birthdays: 'जन्मदिनानि',
    share_link: 'बन्धनम्\u2026',
    moons_badge: '१३ चन्द्राः',
    bluemoon_year: 'नीलचन्द्रवर्षम्',
    year_animal: '{0} वर्षम्',
    tonight: 'अद्यरात्रौ',
    night_sky: 'रात्र्याकाशः',
    planets: 'ग्रहाः:',
    meteor_peaks: 'उल्काशिखराः:',
    view_sky_btn: 'आकाशदर्शनम्',
    scroll_hint: 'वर्धनाय स्क्रॉल \u00b7 सरणाय खिञ्च \u00b7 पुनः स्थापनाय द्विस्पर्श',
    today_marker: '\u2014 अद्य \u2014',
    no_events: 'षष्टिदिनेषु कोऽपि उत्सवः नास्ति।',
    no_birthdays_share: 'साझा करणीयं जन्मदिनं नास्ति',
    link_copied: 'बन्धनं प्रतिलिपितम्! परिवाराय प्रेषयतु।',
    copy_failed: 'प्रतिलिपिः नासीत् \u2014 पुनः प्रयतस्व',
    days_count: '{0} दिनानि',
    leap_year: '१३ मासाः \u00b7 अधिकवर्षम्',
    mythic_on: 'पौराणिकसप्ताहः सक्रियः', mythic_off: 'पौराणिकसप्ताहः निष्क्रियः',
    holidays_on: 'उत्सवाः सक्रियाः',      holidays_off: 'उत्सवाः निष्क्रियाः',
    meteors_on: 'उल्काः सक्रियाः',        meteors_off: 'उल्काः निष्क्रियाः',
    comets_on: 'धूमकेतवः सक्रियाः',      comets_off: 'धूमकेतवः निष्क्रियाः',
    birthdays_on: 'जन्मदिनानि सक्रियानि', birthdays_off: 'जन्मदिनानि निष्क्रियानि',
    otherdate_on: 'अन्यतिथिः सक्रियः',    otherdate_off: 'अन्यतिथिः निष्क्रियः',
    view_fairy: 'चान्द्रः', view_greg: 'ग्रेग.', view_week: 'सप्ताहः',
    view_sky: 'आकाशः', sky_short: 'आ', view_hebrew: 'हिब्रू',
    darkmoon_tooltip: 'तमश्चन्द्रः \u00b7 {0}',
    print_sub: 'पौराणिकचान्द्रः', print_title: 'पञ्चाङ्गम्',
    print_holocene: 'मानवयुगस्य {0} वर्षम्',
    print_animal: '{0} वर्षम् \u00b7 {1} चन्द्राः',
    no_bdays_yet: 'अद्यापि जन्मदिनानि न सन्ति।',
    review_bdays: '{0} जन्मदिन{1} पश्यतु',
    bdays_added: '{0} जन्मदिन{1} योजितम्',
    label_theme: 'विषयः:', label_color: 'वर्णः:',
    theme_fairy: 'परी', theme_wizard: 'जादूगरः', theme_celtic: 'केल्टिकम्', theme_animal: 'पशुः', theme_flower: 'पुष्पम्',
    toggle_mythic: 'पौराणिकसप्ताहः', toggle_otherdate: 'अन्यतिथिः', toggle_holidays: 'उत्सवाः',
    toggle_birthdays: 'जन्मदिनानि', toggle_meteors: 'उल्काः', toggle_comets: 'धूमकेतवः',
    sky_hint: 'आकाशगणनाय। ऋणात्मकं देशांशः = पश्चिमम्।',
    name_ph: 'नाम', day_ph: 'दिनम्',
    mode_calendar: 'पञ्चाङ्गम्', mode_calendar_short: 'पं', label_view: 'दृश्यम्', span_month: 'मासः',
    btn_prev_year: 'पूर्ववर्षम्', btn_next_year: 'अग्रिमवर्षम्', btn_pick_date: 'तिथिचयनम्',
    btn_options: 'विकल्पाः', btn_about: 'विषये', btn_print: 'मुद्रणम्',
...
/** Get weekday name at index using the primary language. */
function tWeekday(idx) {
  const key = (typeof state !== 'undefined' && state.weekNames === 'std') ? 'weekdays_std' : 'weekdays_myth';
  const arr = tArr(key);
  return arr[idx] ?? getWeekdays()[idx];
}
